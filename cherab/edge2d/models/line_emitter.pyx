...
from cherab.edge2d cimport Edge2DFunction


cdef class Edge2DLineEmitter(PlasmaModel):
    """
    Line emitter that uses a custom `Edge2DFunction` function for radiation power density.

    :param Edge2DFunction radiation_function: The power density function defined on the Edge2D mesh.
    ...
    def __init__(self, Edge2DFunction radiation_function, Line line, Plasma plasma=None, AtomicData atomic_data=None,
